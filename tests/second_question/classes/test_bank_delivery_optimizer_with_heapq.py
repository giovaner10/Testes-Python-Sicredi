...
class TestBankDeliveryOptimizerHeapq(TestCase):
    """
    Classe de teste para a função BankDeliveryOptimizer.calculate_minimal_trips_with_heapq.
    """
    ...
    def test_single_trip_enough(self):
        ...
        result = BankDeliveryOptimizer.calculate_minimal_trips_with_heapq(requests, max_value_per_trip)
